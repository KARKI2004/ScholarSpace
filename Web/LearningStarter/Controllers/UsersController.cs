...
public class UsersController : ControllerBase
{
        ...
        [FromBody] UserCreateDto userCreateDto)
    {
        ...
        if (userCreateDto.UniversityId == 0)
        {
            response.AddError("UniversityName", "University cannot be empty.");
        }
        ...
        _userManager.AddToRoleAsync(userToCreate, "Student").Wait();
        ...
        var userGetDto = new UserGetDto
        {
            ...
            UniversityId = userToCreate.UniversityId,
        ...
        [FromBody] UserUpdateDto userUpdateDto)
    {
        ...
        userToEdit.Status = userUpdateDto.Status;
